...
{}% {$\mprog'$ shifted by $n$ is a }
% explain: (q' >> something) is a subsegment of q starting at n...

% make 'is a prefix of' a formal judgement
...
% consider different symbols for the different correspondence judgements
...
\begin{theorem}[Preservation \textnormal{\slang-\mlang}]
