...
For most language constructs the general technique is well-known and adapting it to our mechanisation should be manageable, especially since Pfenning's course notes includes a section \cite[ch. 6.2]{Pfenning01} about such extensions for the first phase of our translation.
...
It is then not obvious how to best represent closures, e.g. flat versus linked closures (as covered by Appel and Jim \cite{AppelJim88}).
