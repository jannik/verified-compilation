...
\ensurecommand{\bvalext}{\hat{\bval}}
\ensurecommand{\benvext}{\hat{\benv}}
\ensurecommand{\hbctx}{\Theta}%
\ensurecommand{\cor}[2]{\ensuremath{#1 \rightsquigarrow #2}}
\ensurecommand{\blookext}[3]{\ensuremath{#1 \vdash #2 \Uparrow #3}}
\ensurecommand{\trahb}[4]{\ensuremath{#2 \vdash #4 \mathrel{\lhd} #3}} % a bit of a hack
...
% conclusion
\ensurecommand{\trahbqual}[2]{\ensuremath{\envnil \vdash #2 \mathrel{\lhd_{\mathrm{FB}}} #1}}
