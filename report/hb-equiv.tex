...
If \trahb{\benv}{\benvdots{\varext \envcons \varext_1}{\varext_n}}{\bexp}{\hexp} (by $\T$), $\varext \neq \varext_k$ for $1 \le k \le n$ and \corhb{\benv}{\bval}{\hval} (by $\C$) then \trahb{\benv \envcons \bval}{\benvdots{\hbvar_1}{\hbvar_n}}{\bexp}{\sub{\hexp}{\hval}{\var}} (by some $\T'$).
\end{lemma}
...
$\T$ has the form
\begin{prooftree}
  \prem{\Tv}{\blookext{\benv}{\benvdots{\hbvar \envcons \hbvar_1}{\hbvar_n}}{\bvar}{\bvalext'}}
  \prem{\C_1}{\corhb{}{\bvalext'}{\hexp}}
  \binf{\trahb{\benv}{\benvdots{\hbvar \envcons \hbvar_1}{\hbvar_n}}{\bvar}{\hexp}}
\end{prooftree}
By Lemma~\ref{lem:substitution-lookup} on $\Tv$ we get \blookext{\benv \envcons \bval}{\benvdots{\hbvar_1}{\hbvar_n}}{\bvar}{\sub{\bvalext'}{\bval}{\varext}} (by $\Tv'$).
...
\begin{prooftree}
  \prem{\Tv'}{\blookext{\benv \envcons \bval}{\benvdots{\hbvar_1}{\hbvar_n}}{\bvar}{\sub{\bvalext'}{\bval}{\var}}}
  \prem{\C_1'}{\corhb{\benv}{\sub{\bvalext'}{\bval}{\var}}{\sub{\hexp}{\hval}{\var}}}
  \binf{\trahb{\benv \envcons \bval}{\benvdots{\hbvar_1}{\hbvar_n}}{\bvar}{\sub{\hexp}{\hval}{\var}}}
\end{prooftree}

\paragraph{Case \textnormal{\rulename{T-Lam}}}
$\T$ has the form
\begin{prooftree}
	\prem{\T_1}{\trahb{\benv}{\benvdots{\hbvar \envcons \hbvar_1}{\hbvar_n \envcons \hbothervar}}{\bexp_1}{\hexp_1}}
  \uinf{\trahb{\benv}{\benvdots{\hbvar \envcons \hbvar_1}{\hbvar_n}}{\blam{\bexp_1}}{\lam{\othervar}{\hexp_1}}}
\end{prooftree}
If $\var = \othervar$ then $\sub{(\lam{\othervar}{\hexp_1})}{\hval}{\var} = \lam{\othervar}{\hexp_1}$ and we use Lemma~\ref{lem:shadowing} on $\T_1$ to get \trahb{\benv \envcons \bval}{\benvdots{\hbvar_1}{\hbvar_n \envcons \hbothervar}}{\bexp_1}{\hexp_1} (by some $\T_1'$).
...
By IH on $\T_1$ with $\C$ we get \trahb{\benv \envcons \bval}{\benvdots{\hbvar_1}{\hbvar_n \envcons \othervarext}}{\bexp_1}{\sub{\hexp_1}{\hval}{\var}} (by $\T_1'$) which has the right shape to finish the case with \rulename{T-Lam}.
