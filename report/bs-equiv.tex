...
\begin{proof}
By induction on $\B$.
The proof is rather straightforward, but the universal quantification of $\sctrl$ and $\svals$ introduces some subtlety since we need to use the induction hypothesis with different instantiations.
We show the most interesting case here:
