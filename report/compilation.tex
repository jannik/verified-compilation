...
\newcommand{\hcase}[3]{\mathtt{case} \; #1 \; #2 \; #3}
\newcommand{\bsuc}[1]{\mathtt{bsuc} \; #1}
\newcommand{\bcase}[3]{\mathtt{bcase} \; #1 \; #2 \; #3}
\newcommand{\ssuc}{\mathtt{ssuc}}
\newcommand{\scase}[2]{\mathtt{scase} \; #1 \; #2}
...
% will make sense with proper case syntax (that binds x)
\begin{prooftree}
  \ninf{\ev{\e_1}{\n{\suc{n}}}}
  \ninf{\ev{\sub{\e_3}{\n{n}}{x}}{\c_3}}
	\leftl{\rule{E-Case-s} :}
...
\begin{prooftree}
  \ninf{\tra{\De}{\e_1}{\b_1}}
	\leftl{\rule{T-Suc} :}
  \uinf{\tra{\De}{\hsuc{\e_1}}{\bsuc{\b_1}}}
\end{prooftree}

% missing rule for case

% trans-hb/case : trans-hb Sigma (bcase B1 B2 B3) (case E1 E2 E3)
%                  <- trans-hb Sigma B1 E1
%                  <- trans-hb Sigma B2 E2
%                  <- ({v : value} {x : exp}
%                        cor v x -> trans-hb (store/cons Sigma v) B3 (E3 x)).
...
\noindent \judgement{\tracc{\b}{\ss}{\ss'}}
...
\noindent \judgement{\meval{\q}{\k}{\r}}

\noindent \judgement{\mev{\q}{\H}{\Gamma}{\k}{\Phi}{\H'}{\Gamma'}{\k'}{\Phi'}}
...
\noindent \judgement{\mmev{\q}{\H}{\Gamma}{\k}{\Phi}{\H'}{\Gamma'}{\k'}{\Phi'}}

\noindent \judgement{\fetch{\q}{\k}{\m}}

\noindent \judgement{\fetch{\Gamma}{\o}{\r}}
