...
\begin{prooftree}
	\ninf{\trahb{\Theta :: \cor{\h{b}}{x}}{\a :: \h{b}}{b_1}{e_1}}
  \leftl{\rule{T-Lam} :}
  \rightl{$(\forall \h{b}' . \; (\cor{\h{b}'}{x}) \notin \Theta)$}
  \uinf{\trahb{\Theta}{\a}{\lam{}{\h{b}_1}}{\lam{x}{e_1}}}
\end{prooftree}
...
If \trahb{\Theta}{\a}{e}{b} (by $\T$) and \bev{\a}{\b}{\h{b}} (by $\B$), then there exists $\h{e}$ such that \hev{e}{\c} (by some $\E$) and \corhb{\Theta}{\h{b}}{\h{e}} (by some $\C$).
\end{lemma}

\begin{lemma}[Completeness]
\label{lem:completeness-hb}
If \trahb{\Theta}{\a}{e}{b} (by $\T$) and \hev{e}{\h{e}} (by $\E$), then there exists $\h{b}$ such that \bev{\a}{\b}{\h{b}} (by some $\B$) and \corhb{\Theta}{\h{b}}{\h{e}} (by some $\C$).
\end{lemma}
