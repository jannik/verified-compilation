...
We translate from de Bruijn expressions to stack instructions using the following judgment.
\vspace{0.5cm}
...
\begin{prooftree}
  ...
  \ninf{\tr{\b_2}{\ss_2}}
  \leftl{\rule{T-App} :}
  \binf{\tr{\b_1 \app \b_2}{\ss_1, \ss_2, \sapp}}
\end{prooftree}
...
\begin{prooftree}
  \leftl{\rule{S-Lam} :}
  \ax{\sev{\Xi, \fr{\tau}{(\lam{}{\s_1}), \ss}}{\Psi}{\Xi, \fr{\tau}{\ss}}{\Psi, \cl{\tau}{\s_1}}}
\end{prooftree}
...
\begin{theorem}
If \tr{\b}{\ss}, then \hev{\b}{\n{n}} if and only if \ev{\ss}{\n{n}}.
\end{theorem}

To prove this we need an additional judgement.
\vspace{0.5cm}
...
\begin{lemma}
If \tr{\b}{\ss} and \hev{\sg}{\b}{\v} where \cor{\sg}{\tau} then for all $\Xi$ and $\Psi$ there exists a $\w$ such that \sev{\Xi, \fr{\tau}{\ss}}{\Psi}{\Xi, \fr{\tau}{\nil}}{\Psi, \w} with \cor{\v}{\w}.
\end{lemma}

What should the lemma for the other direction be?
