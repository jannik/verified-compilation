...
\ensurecommand{\trahb}[4]{\ensuremath{#2 \vdash #3 \rhd #4}} % a bit of a hack
...
Given a variable $\var$, if \trahb{\hbctx}{\benv}{\bexp}{\bval} and \corhb{\hbctx}{\bval'}{\hval'} then \trahb{\hbctx}{\sub{\benv}{\bval'}{\var}}{\bexp}{\sub{\hexp}{\hval'}{\var}}.
\end{lemma}
% something about 'for all e'?
...
Using Lemma~\ref{lem:substitution} on $\T_3$ with $\C_2$ we get \trahb{\hbctx}{\benv \envcons \hval_2}{\bexp_0}{\sub{\hexp_0}{\hexp_2}{\var}} (by some $\T_3'$).
