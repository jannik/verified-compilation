...
We define De-Bruijn values $\h{b}$ as follows, and environments $\alpha$ are then ordered lists of values.
\begin{align*}
  \h{b} &\defi \n{n} \alt \cl{\sg}{\b} \\
  \alpha &\defi \nil \alt \alpha, \h{b} \\
\end{align*}
...
\judgement{\hlook{\alpha}{i}{\h{b}}}

\begin{prooftree}
  \leftl{\rule{Bv-Here} :}
  \ax{\hlook{\alpha, \h{b}}{\z}{\h{b}}}
\end{prooftree}
...
\begin{prooftree}
  \ninf{\hlook{\alpha}{i}{\h{b}}}
  \leftl{\rule{B-Var} :}
  \uinf{\bev{\alpha}{i}{\h{b}}}
\end{prooftree}

\begin{prooftree}
  \leftl{\rule{B-Lam :}}
  \ax{\bev{\alpha}{\blam{b_1}}{\cl{\alpha}{b_1}}}
\end{prooftree}

\begin{prooftree}
  \ninf{\bev{\alpha}{b_1}{\cl{\alpha'}{b_0}}}
  \ninf{\bev{\alpha}{b_2}{\h{b}_2}}
  \ninf{\bev{\alpha', \h{b}_2}{b_0}{\h{b}}}
	\leftl{\rule{B-App} :}
  \tinf{\bev{\alpha}{b_1 \app b_2}{\h{b}}}
\end{prooftree}

\begin{prooftree}
  \ninf{\bev{\alpha}{b_1}{\n{n}}}
	\leftl{\rule{B-Suc} :}
  \uinf{\bev{\alpha}{\bsuc{b_1}}{{\n{n+1}}}}
\end{prooftree}

%% \begin{prooftree}
%%   \ninf{\hev{\alpha}{\b_1}{\n{0}}}
%%   \ninf{\hev{\alpha}{\b_2}{\v_2}}
%% 	\leftl{\rule{B-Case-z} :}
%%   \binf{\hev{\alpha}{\bcase{\b_1}{\b_2}{\b_3}}{\v_2}}
%% \end{prooftree}
...
%% 	\leftl{\rule{B-Case-s} :}
%% 	\rightl{$(n > 0)$}
%%   \binf{\hev{\alpha}{\bcase{\b_1}{\b_2}{\b_3}}{\v_3}}
%% \end{prooftree}
...
\begin{prooftree}
  \ninf{\hevv{\alpha}{i}{\h{b}}}
  \ninf{\corhb{\Theta}{\h{b}}{e}}
  \leftl{\rule{T-Var} :}
  \binf{\tra{\Theta}{\alpha}{i}{e}}
\end{prooftree}
...
\begin{prooftree}
	\ninf{\trahb{\Theta :: \cor{\h{b}}{x}}{\alpha :: \h{b}}{b_1}{e_1}}
  \leftl{\rule{T-Lam} :}
  \rightl{$(\forall \h{b}' . \; (\cor{\h{b}'}{x}) \notin \Theta)$}
  \uinf{\trahb{\Theta}{\alpha}{\lam{}{\h{b}_1}}{\lam{x}{e_1}}}
\end{prooftree}

\begin{prooftree}
  \ninf{\trahb{\Theta}{\alpha}{b_1}{e_1}}
  \ninf{\trahb{\Theta}{\alpha}{b_2}{e_2}}
	\leftl{\rule{T-App} :}
  \binf{\trahb{\Theta}{\alpha}{b_1 \app b_2}{e_1 \app e_2}}
\end{prooftree}

\begin{prooftree}
  \ninf{\trahb{\Theta}{\alpha}{b_1}{e_1}}
	\leftl{\rule{T-Suc} :}
  \uinf{\trahb{\Theta}{\alpha}{\bsuc{b_1}}{\hsuc{e_1}}}
\end{prooftree}

%% \begin{prooftree}
%% 	\ninf{\trahb{\Theta}{\alpha}{b_1}{e_1}}
%% 	\ninf{\trahb{\Theta}{\alpha}{b_2}{e_2}}
%% 	\ninf{\trahb{\Theta, \cor{\h{b}}{x}}{\alpha, \h{b}}{b_3}{e_3}}
%%   \leftl{\rule{T-Case} :}
%%   \rightl{$(\forall \h{b}' . \; (\cor{\h{b}'}{x}) \notin \Theta)$}
%%   \tinf{\trahb{\Theta}{\alpha}{\bcase{b_1}{b_2}{b_3}}{\hcase{e_1}{e_2}{e_3}}}
%% \end{prooftree}
...
\begin{prooftree}
  \ninf{\trahb{\Theta}{\alpha}{\blam{b}}{\lam{x}{e}}}
  \leftl{\rule{C-Fun} :}
  \uinf{\corhb{\Theta}{\cl{\alpha}{b}}{\lam{x}{e}}}
\end{prooftree}
...
If \trahb{\Theta}{\alpha}{e}{b} (by $\T$) and \bev{\alpha}{\b}{\h{b}} (by $\B$), then there exists $\h{e}$ such that \hev{e}{\c} (by some $\E$) and \corhb{\Theta}{\h{b}}{\h{e}} (by some $\C$).
\end{lemma}

\begin{lemma}[Completeness]
\label{lem:completeness-hb}
If \trahb{\Theta}{\alpha}{e}{b} (by $\T$) and \hev{e}{\h{e}} (by $\E$), then there exists $\h{b}$ such that \bev{\alpha}{\b}{\h{b}} (by some $\B$) and \corhb{\Theta}{\h{b}}{\h{e}} (by some $\C$).
\end{lemma}
...
\begin{prooftree}
  \ax{\mexec{q}{\mpushnum{n}}{\D \cons \cl{\c, \lret}}{\l}{\Ps}{\D \cons \cl{\c}{\l}}{\l}{\Ps, \n{n}}}
\end{prooftree}
