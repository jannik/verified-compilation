...
Let $\l$ denote labels.
We define label-machine instructions $\m$, basic blocks $\b$, and programs $\q$:

\begin{align*}
  \m &\defi \mpushnum{n} \alt \mpushvar{i} \alt \mpushclos{\l} \\
  \b &\defi \m, \b \alt \mcall{\l} \alt \mret \\
  \q &\defi \nil \alt \l: \b, \q
\end{align*}
...
\vspace{0.5cm}
\judgement{$\ss \circ \tup{\q; \l} \rhd \tup{\b; \q'; \l'}$}
\vspace{0.5cm}

(See code for rules and an attempt at formulating the soundness lemma.)
