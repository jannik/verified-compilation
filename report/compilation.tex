...
We then construct the required the required $\C$ as follows:
\begin{prooftree}
  \prem{\D}{\comp{\sg}{\De}{\phi}}
  \prem{\T_1}{\tra{\De, x}{\e_1}{\b_1}}
  \binf{\cor{\cl{\sg}{\b_1}}{\lam{x}{\subs{\e_1}{\phi \wo x}}}}
...
Then by IH on $\B_3$ with $\T_1'$ and $\D'$, we get a derivation $\E_3$ of \ev{\subs{\e_0'}{\phi'[x \mapsto \c_2]}}{\c} along with the required $\C$ showing \cor{\v}{\c}.
